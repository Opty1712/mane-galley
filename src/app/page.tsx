...
import { checkIsMobile, getProject, Project, projects } from "../utils";
      ...
      >
        ...
        <div className={styles.grid7}>
          ...
          <div style={{ marginTop: "1vh" }}>
            <Typograph>
              Проект под NDA, ссылки и скриншоты недоступны, подробнее расскажу
              на собеседовании
            </Typograph>
          </div>
        ...
        >
          ...
          <span>
            ...
            <Typograph>
              ...
              уникальных пользователей и перевести их на платную подписку. Срок
              — 3 месяца!
            </Typograph>
          </span>
      ...
      >
        ...
        >
          ...
          <span>
            <div className={styles.projectSubHeader}>[Бизнес-задача]</div>
            <Typograph>
              Сохранить аудиторию приложения Uncle VPN после блокировки в Google
              Play / AppStore
            </Typograph>
          </span>
          <span>
      ...
      >
        ...
        >
          ...
          <span>
            <div className={styles.projectSubHeader}>[Бизнес-задача]</div>
            <Typograph>
              Итерационная цифровизация оффлайн-бизнеса с увеличением конверсии
              в покупку на сайте. Обновление визуальной коммуникации, улучшение
              клиентского опыта в вебе
            </Typograph>
          </span>
          <span>
            <div className={styles.projectSubHeader}>[Результат]</div>
  ...
  return (
    <>
      ...
      <section id="projects" className={styles.section}>
        {projects.map(({ slug }) => ProjectsContent[slug])}
      </section>
